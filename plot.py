...
def ploting(loss_list_train, loss_list_test):
    ...
    pylab.plot(loss_list_test[0], lw="2",  color='y')
    pylab.plot(loss_list_test[1], lw="2", color='c')
    pylab.plot(loss_list_test[2], lw="2", color='g')
    pylab.plot(loss_list_test[3], lw="2", color='r')
    pylab.plot(loss_list_test[4], lw="2", color='k')
